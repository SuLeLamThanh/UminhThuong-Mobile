...
namespace ResearchDatabase.Infrastructure.Migrations
{
    ...
    [Migration("20241214064935_update5")]
            ...
            modelBuilder.Entity("ResearchDatabase.Domain.Entities.ResearchRecord", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Notes = "GTM-001",
                            ResearchDate = new DateTime(2020, 12, 14, 13, 49, 34, 213, DateTimeKind.Local).AddTicks(5317),
                            ResearchSubjectId = 1,
                            Result = "Successful"
                        },
                        new
                        {
                            ...
                            Notes = "GTM-002",
                            ResearchDate = new DateTime(2022, 12, 14, 13, 49, 34, 213, DateTimeKind.Local).AddTicks(6465),
                            ResearchSubjectId = 2,
                        ...
                        new
                        {
                            ...
                            Notes = "GTM-002",
                            ResearchDate = new DateTime(2023, 12, 14, 13, 49, 34, 213, DateTimeKind.Local).AddTicks(6471),
                            ResearchSubjectId = 3,
            ...
            modelBuilder.Entity("ResearchDatabase.Domain.Entities.ResearchSubject", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2024, 12, 14, 13, 49, 34, 213, DateTimeKind.Local).AddTicks(782),
                            Name = "Lion Conservation",
                            Project = "Save the Lions",
                            StartDate = new DateTime(2019, 12, 14, 13, 49, 34, 212, DateTimeKind.Local).AddTicks(957),
                            Status = "Completed",
                            TeamMembers = "Team A"
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2021, 12, 14, 13, 49, 34, 213, DateTimeKind.Local).AddTicks(1837),
                            Status = "Ongoing",
                            TeamMembers = "Team B"
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2022, 12, 14, 13, 49, 34, 213, DateTimeKind.Local).AddTicks(1847),
                            Status = "Ongoing",
                            TeamMembers = "Team C"
                        });
                });

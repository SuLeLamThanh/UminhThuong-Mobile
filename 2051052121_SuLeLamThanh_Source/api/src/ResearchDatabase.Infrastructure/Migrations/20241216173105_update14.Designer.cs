...
namespace ResearchDatabase.Infrastructure.Migrations
{
    ...
    [Migration("20241216173105_update14")]
            ...
            modelBuilder.Entity("ResearchDatabase.Domain.Entities.ResearchRecord", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Notes = "GTM-001",
                            ResearchDate = new DateTime(2020, 12, 17, 0, 31, 4, 227, DateTimeKind.Local).AddTicks(8625),
                            ResearchSubjectId = 1,
                            Result = "Successful"
                        },
                        new
                        {
                            ...
                            Notes = "GTM-002",
                            ResearchDate = new DateTime(2022, 12, 17, 0, 31, 4, 227, DateTimeKind.Local).AddTicks(9779),
                            ResearchSubjectId = 2,
                        ...
                        new
                        {
                            ...
                            Notes = "GTM-002",
                            ResearchDate = new DateTime(2023, 12, 17, 0, 31, 4, 227, DateTimeKind.Local).AddTicks(9785),
                            ResearchSubjectId = 3,
            ...
            modelBuilder.Entity("ResearchDatabase.Domain.Entities.ResearchSubject", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2024, 12, 17, 0, 31, 4, 227, DateTimeKind.Local).AddTicks(3877),
                            Name = "Lion Conservation",
                            Project = "Save the Lions",
                            StartDate = new DateTime(2019, 12, 17, 0, 31, 4, 226, DateTimeKind.Local).AddTicks(4549),
                            Status = "Completed",
                            TeamMembers = "Team A"
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2021, 12, 17, 0, 31, 4, 227, DateTimeKind.Local).AddTicks(4943),
                            Status = "Ongoing",
                            TeamMembers = "Team B"
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2022, 12, 17, 0, 31, 4, 227, DateTimeKind.Local).AddTicks(4954),
                            Status = "Ongoing",
                            TeamMembers = "Team C"
                        });
                });

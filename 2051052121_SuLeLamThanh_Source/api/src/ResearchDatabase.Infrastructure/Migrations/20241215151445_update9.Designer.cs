...
namespace ResearchDatabase.Infrastructure.Migrations
{
    ...
    [Migration("20241215151445_update9")]
            ...
            modelBuilder.Entity("ResearchDatabase.Domain.Entities.ResearchRecord", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Notes = "GTM-001",
                            ResearchDate = new DateTime(2020, 12, 15, 22, 14, 44, 637, DateTimeKind.Local).AddTicks(9386),
                            ResearchSubjectId = 1,
                            Result = "Successful"
                        },
                        new
                        {
                            ...
                            Notes = "GTM-002",
                            ResearchDate = new DateTime(2022, 12, 15, 22, 14, 44, 638, DateTimeKind.Local).AddTicks(583),
                            ResearchSubjectId = 2,
                        ...
                        new
                        {
                            ...
                            Notes = "GTM-002",
                            ResearchDate = new DateTime(2023, 12, 15, 22, 14, 44, 638, DateTimeKind.Local).AddTicks(589),
                            ResearchSubjectId = 3,
            ...
            modelBuilder.Entity("ResearchDatabase.Domain.Entities.ResearchSubject", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2024, 12, 15, 22, 14, 44, 637, DateTimeKind.Local).AddTicks(4462),
                            Name = "Lion Conservation",
                            Project = "Save the Lions",
                            StartDate = new DateTime(2019, 12, 15, 22, 14, 44, 636, DateTimeKind.Local).AddTicks(4933),
                            Status = "Completed",
                            TeamMembers = "Team A"
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2021, 12, 15, 22, 14, 44, 637, DateTimeKind.Local).AddTicks(5522),
                            Status = "Ongoing",
                            TeamMembers = "Team B"
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2022, 12, 15, 22, 14, 44, 637, DateTimeKind.Local).AddTicks(5532),
                            Status = "Ongoing",
                            TeamMembers = "Team C"
                        });
                });

    ...
    public partial class update12 : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 3,
                columns: new[] { "Notes", "ResearchDate" },
                values: new object[] { "GTM-003", new DateTime(2023, 12, 16, 0, 21, 59, 611, DateTimeKind.Local).AddTicks(5582) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 4, 60000f, "Studying the role of kelp in marine ecosystems", null, "Kelp Ecology", "Exploring Kelp Forests", new DateTime(2023, 12, 16, 0, 21, 59, 610, DateTimeKind.Local).AddTicks(6593), "Ongoing", "Team D" },
                    { 5, 120000f, "Research on the molecular biology of plant viroids", new DateTime(2022, 12, 16, 0, 21, 59, 610, DateTimeKind.Local).AddTicks(6598), "Viroid Research", "Understanding Viroids", new DateTime(2020, 12, 16, 0, 21, 59, 610, DateTimeKind.Local).AddTicks(6595), "Completed", "Team E" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 4, "Examining kelp forest biodiversity", "Kelp Biodiversity Study", "GTM-004", new DateTime(2024, 6, 16, 0, 21, 59, 611, DateTimeKind.Local).AddTicks(5585), 4, "Ongoing", null },
                    { 5, "Investigating plant viroid infections in cereals", "Viroid Infection Study", "GTM-005", new DateTime(2021, 12, 16, 0, 21, 59, 611, DateTimeKind.Local).AddTicks(5622), 5, "Completed", null }
                });

...
namespace ResearchDatabase.Infrastructure.Migrations
{
    ...
    [Migration("20241214112152_update8")]
            ...
            modelBuilder.Entity("ResearchDatabase.Domain.Entities.ResearchRecord", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Notes = "GTM-001",
                            ResearchDate = new DateTime(2020, 12, 14, 18, 21, 51, 646, DateTimeKind.Local).AddTicks(4223),
                            ResearchSubjectId = 1,
                            Result = "Successful"
                        },
                        new
                        {
                            ...
                            Notes = "GTM-002",
                            ResearchDate = new DateTime(2022, 12, 14, 18, 21, 51, 646, DateTimeKind.Local).AddTicks(5364),
                            ResearchSubjectId = 2,
                        ...
                        new
                        {
                            ...
                            Notes = "GTM-002",
                            ResearchDate = new DateTime(2023, 12, 14, 18, 21, 51, 646, DateTimeKind.Local).AddTicks(5370),
                            ResearchSubjectId = 3,
            ...
            modelBuilder.Entity("ResearchDatabase.Domain.Entities.ResearchSubject", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2024, 12, 14, 18, 21, 51, 645, DateTimeKind.Local).AddTicks(9652),
                            Name = "Lion Conservation",
                            Project = "Save the Lions",
                            StartDate = new DateTime(2019, 12, 14, 18, 21, 51, 644, DateTimeKind.Local).AddTicks(9806),
                            Status = "Completed",
                            TeamMembers = "Team A"
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2021, 12, 14, 18, 21, 51, 646, DateTimeKind.Local).AddTicks(734),
                            Status = "Ongoing",
                            TeamMembers = "Team B"
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2022, 12, 14, 18, 21, 51, 646, DateTimeKind.Local).AddTicks(745),
                            Status = "Ongoing",
                            TeamMembers = "Team C"
                        });
                });

...
namespace ResearchDatabase.Infrastructure.Migrations
{
    ...
    [Migration("20241209170010_updateData")]
            ...
            modelBuilder.Entity("ResearchDatabase.Domain.Entities.ResearchRecord", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Notes = "GTM-001",
                            ResearchDate = new DateTime(2020, 12, 10, 0, 0, 8, 486, DateTimeKind.Local).AddTicks(7802),
                            ResearchSubjectId = 1,
                            Result = "Successful"
                        },
                        new
                        {
                            ...
                            Notes = "GTM-002",
                            ResearchDate = new DateTime(2022, 12, 10, 0, 0, 8, 486, DateTimeKind.Local).AddTicks(9000),
                            ResearchSubjectId = 2,
                        ...
                        new
                        {
                            ...
                            Notes = "GTM-002",
                            ResearchDate = new DateTime(2023, 12, 10, 0, 0, 8, 486, DateTimeKind.Local).AddTicks(9006),
                            ResearchSubjectId = 3,
            ...
            modelBuilder.Entity("ResearchDatabase.Domain.Entities.ResearchSubject", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2024, 12, 10, 0, 0, 8, 486, DateTimeKind.Local).AddTicks(2701),
                            Name = "Lion Conservation",
                            Project = "Save the Lions",
                            StartDate = new DateTime(2019, 12, 10, 0, 0, 8, 485, DateTimeKind.Local).AddTicks(3097),
                            Status = "Completed",
                            TeamMembers = "Team A"
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2021, 12, 10, 0, 0, 8, 486, DateTimeKind.Local).AddTicks(3804),
                            Status = "Ongoing",
                            TeamMembers = "Team B"
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2022, 12, 10, 0, 0, 8, 486, DateTimeKind.Local).AddTicks(3814),
                            Status = "Ongoing",
                            TeamMembers = "Team C"
                        });
                });

    ...
    public partial class update10 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { "GTM-003", new DateTime(2023, 12, 16, 0, 7, 49, 877, DateTimeKind.Local).AddTicks(3922) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 4, 60000f, "Studying the role of kelp in marine ecosystems", null, "Kelp Ecology", "Exploring Kelp Forests", new DateTime(2023, 12, 16, 0, 7, 49, 876, DateTimeKind.Local).AddTicks(8242), "Ongoing", "Team D" },
                    { 5, 120000f, "Research on the molecular biology of plant viroids", new DateTime(2022, 12, 16, 0, 7, 49, 876, DateTimeKind.Local).AddTicks(8246), "Viroid Research", "Understanding Viroids", new DateTime(2020, 12, 16, 0, 7, 49, 876, DateTimeKind.Local).AddTicks(8244), "Completed", "Team E" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 4, "Examining kelp forest biodiversity", "Kelp Biodiversity Study", "GTM-004", new DateTime(2024, 6, 16, 0, 7, 49, 877, DateTimeKind.Local).AddTicks(3924), 4, "Ongoing", null },
                    { 5, "Investigating plant viroid infections in cereals", "Viroid Infection Study", "GTM-005", new DateTime(2021, 12, 16, 0, 7, 49, 877, DateTimeKind.Local).AddTicks(3952), 5, "Completed", null }
                });
            ...
            migrationBuilder.InsertData(
                table: "Orders",
                columns: new[] { "Id", "ClassId", "Name" },
                values: new object[] { 17, 15, "Agaricales" });
            ...
            migrationBuilder.InsertData(
                table: "Families",
                columns: new[] { "Id", "Name", "OrderId" },
                values: new object[] { 20, "Agaricaceae", 17 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 10, 4, "Ciliatea" },
                    { 11, 4, "Dinoflagellata" },
                    { 12, 7, "Methanococcales" },
                    { 13, 7, "Methanobacteriales" },
                    { 18, 16, "Coleochaetales" },
            ...
            migrationBuilder.InsertData(
                table: "Genera",
                columns: new[] { "Id", "FamilyId", "Name" },
                values: new object[] { 25, 22, "Spirochaeta" });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 3,
                columns: new[] { "ClassId", "Name" },
                values: new object[] { 3, "Hypocreales" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 3,
                columns: new[] { "Notes", "ResearchDate" },
                values: new object[] { "GTM-002", new DateTime(2023, 12, 15, 22, 14, 44, 638, DateTimeKind.Local).AddTicks(589) });

...
namespace ResearchDatabase.Infrastructure.Migrations
{
    ...
    [Migration("20241209171803_updateData1")]
            ...
            modelBuilder.Entity("ResearchDatabase.Domain.Entities.ResearchRecord", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Notes = "GTM-001",
                            ResearchDate = new DateTime(2020, 12, 10, 0, 18, 2, 593, DateTimeKind.Local).AddTicks(3830),
                            ResearchSubjectId = 1,
                            Result = "Successful"
                        },
                        new
                        {
                            ...
                            Notes = "GTM-002",
                            ResearchDate = new DateTime(2022, 12, 10, 0, 18, 2, 593, DateTimeKind.Local).AddTicks(5049),
                            ResearchSubjectId = 2,
                        ...
                        new
                        {
                            ...
                            Notes = "GTM-002",
                            ResearchDate = new DateTime(2023, 12, 10, 0, 18, 2, 593, DateTimeKind.Local).AddTicks(5056),
                            ResearchSubjectId = 3,
            ...
            modelBuilder.Entity("ResearchDatabase.Domain.Entities.ResearchSubject", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2024, 12, 10, 0, 18, 2, 592, DateTimeKind.Local).AddTicks(8582),
                            Name = "Lion Conservation",
                            Project = "Save the Lions",
                            StartDate = new DateTime(2019, 12, 10, 0, 18, 2, 591, DateTimeKind.Local).AddTicks(9082),
                            Status = "Completed",
                            TeamMembers = "Team A"
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2021, 12, 10, 0, 18, 2, 592, DateTimeKind.Local).AddTicks(9686),
                            Status = "Ongoing",
                            TeamMembers = "Team B"
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2022, 12, 10, 0, 18, 2, 592, DateTimeKind.Local).AddTicks(9698),
                            Status = "Ongoing",
                            TeamMembers = "Team C"
                        });
                });

...
namespace ResearchDatabase.Infrastructure.Migrations
{
    ...
    [Migration("20241216163106_update13")]
            ...
            modelBuilder.Entity("ResearchDatabase.Domain.Entities.ResearchRecord", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Notes = "GTM-001",
                            ResearchDate = new DateTime(2020, 12, 16, 23, 31, 5, 399, DateTimeKind.Local).AddTicks(9763),
                            ResearchSubjectId = 1,
                            Result = "Successful"
                        },
                        new
                        {
                            ...
                            Notes = "GTM-002",
                            ResearchDate = new DateTime(2022, 12, 16, 23, 31, 5, 400, DateTimeKind.Local).AddTicks(917),
                            ResearchSubjectId = 2,
                        ...
                        new
                        {
                            ...
                            Notes = "GTM-003",
                            ResearchDate = new DateTime(2023, 12, 16, 23, 31, 5, 400, DateTimeKind.Local).AddTicks(924),
                            ResearchSubjectId = 3,
                        ...
                        new
                        {
                            ...
                            Notes = "GTM-004",
                            ResearchDate = new DateTime(2024, 6, 16, 23, 31, 5, 400, DateTimeKind.Local).AddTicks(926),
                            ResearchSubjectId = 4,
                            Result = "Ongoing"
                        },
                        new
                        {
                            ...
                            Notes = "GTM-005",
                            ResearchDate = new DateTime(2021, 12, 16, 23, 31, 5, 400, DateTimeKind.Local).AddTicks(953),
                            ResearchSubjectId = 5,
                            Result = "Completed"
                        });
                });
            ...
            modelBuilder.Entity("ResearchDatabase.Domain.Entities.ResearchSubject", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2024, 12, 16, 23, 31, 5, 399, DateTimeKind.Local).AddTicks(4277),
                            Name = "Lion Conservation",
                            Project = "Save the Lions",
                            StartDate = new DateTime(2019, 12, 16, 23, 31, 5, 398, DateTimeKind.Local).AddTicks(5024),
                            Status = "Completed",
                            TeamMembers = "Team A"
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2021, 12, 16, 23, 31, 5, 399, DateTimeKind.Local).AddTicks(5350),
                            Status = "Ongoing",
                            TeamMembers = "Team B"
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2022, 12, 16, 23, 31, 5, 399, DateTimeKind.Local).AddTicks(5361),
                            Status = "Ongoing",
                            TeamMembers = "Team C"
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2023, 12, 16, 23, 31, 5, 399, DateTimeKind.Local).AddTicks(5363),
                            Status = "Ongoing",
                            TeamMembers = "Team D"
                        },
                        new
                        {
                            ...
                            EndDate = new DateTime(2022, 12, 16, 23, 31, 5, 399, DateTimeKind.Local).AddTicks(5367),
                            Name = "Viroid Research",
                            Project = "Understanding Viroids",
                            StartDate = new DateTime(2020, 12, 16, 23, 31, 5, 399, DateTimeKind.Local).AddTicks(5365),
                            Status = "Completed",
                            TeamMembers = "Team E"
                        });
                });

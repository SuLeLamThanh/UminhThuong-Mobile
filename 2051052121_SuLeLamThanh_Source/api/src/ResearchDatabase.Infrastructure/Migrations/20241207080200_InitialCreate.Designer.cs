...
namespace ResearchDatabase.Infrastructure.Migrations
{
    ...
    [Migration("20241207080200_InitialCreate")]
            ...
            modelBuilder.Entity("ResearchDatabase.Domain.Entities.ResearchRecord", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Notes = "This study tracked lions over a period of 6 months in the savannah.",
                            ResearchDate = new DateTime(2020, 12, 7, 15, 1, 59, 449, DateTimeKind.Local).AddTicks(2269),
                            ResearchSubjectId = 1,
                            Result = "Successful"
                        },
                        new
                        {
                            ...
                            Notes = "Data was collected in multiple regions with different climate conditions.",
                            ResearchDate = new DateTime(2022, 12, 7, 15, 1, 59, 449, DateTimeKind.Local).AddTicks(3356),
                            ResearchSubjectId = 2,
                        ...
                        new
                        {
                            ...
                            Notes = "Initial observations indicate a diverse range of fungi species.",
                            ResearchDate = new DateTime(2023, 12, 7, 15, 1, 59, 449, DateTimeKind.Local).AddTicks(3362),
                            ResearchSubjectId = 3,
            ...
            modelBuilder.Entity("ResearchDatabase.Domain.Entities.ResearchSubject", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2024, 12, 7, 15, 1, 59, 448, DateTimeKind.Local).AddTicks(7845),
                            Name = "Lion Conservation",
                            Project = "Save the Lions",
                            StartDate = new DateTime(2019, 12, 7, 15, 1, 59, 447, DateTimeKind.Local).AddTicks(8152),
                            Status = "Completed",
                            TeamMembers = "Team A"
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2021, 12, 7, 15, 1, 59, 448, DateTimeKind.Local).AddTicks(8872),
                            Status = "Ongoing",
                            TeamMembers = "Team B"
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2022, 12, 7, 15, 1, 59, 448, DateTimeKind.Local).AddTicks(8882),
                            Status = "Ongoing",
                            TeamMembers = "Team C"
                        });
                });

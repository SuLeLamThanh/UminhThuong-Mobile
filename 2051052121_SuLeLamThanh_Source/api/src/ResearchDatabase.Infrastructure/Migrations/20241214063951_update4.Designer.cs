...
namespace ResearchDatabase.Infrastructure.Migrations
{
    ...
    [Migration("20241214063951_update4")]
            ...
            modelBuilder.Entity("ResearchDatabase.Domain.Entities.ResearchRecord", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Notes = "GTM-001",
                            ResearchDate = new DateTime(2020, 12, 14, 13, 39, 50, 799, DateTimeKind.Local).AddTicks(4237),
                            ResearchSubjectId = 1,
                            Result = "Successful"
                        },
                        new
                        {
                            ...
                            Notes = "GTM-002",
                            ResearchDate = new DateTime(2022, 12, 14, 13, 39, 50, 799, DateTimeKind.Local).AddTicks(6012),
                            ResearchSubjectId = 2,
                        ...
                        new
                        {
                            ...
                            Notes = "GTM-002",
                            ResearchDate = new DateTime(2023, 12, 14, 13, 39, 50, 799, DateTimeKind.Local).AddTicks(6020),
                            ResearchSubjectId = 3,
            ...
            modelBuilder.Entity("ResearchDatabase.Domain.Entities.ResearchSubject", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2024, 12, 14, 13, 39, 50, 798, DateTimeKind.Local).AddTicks(6209),
                            Name = "Lion Conservation",
                            Project = "Save the Lions",
                            StartDate = new DateTime(2019, 12, 14, 13, 39, 50, 796, DateTimeKind.Local).AddTicks(6480),
                            Status = "Completed",
                            TeamMembers = "Team A"
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2021, 12, 14, 13, 39, 50, 798, DateTimeKind.Local).AddTicks(7804),
                            Status = "Ongoing",
                            TeamMembers = "Team B"
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2022, 12, 14, 13, 39, 50, 798, DateTimeKind.Local).AddTicks(7824),
                            Status = "Ongoing",
                            TeamMembers = "Team C"
                        });
                });
            ...
            modelBuilder.Entity("ResearchDatabase.Domain.Entities.Species", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            ConservationStatusId = 1,
                            GenusId = 3,
                            ImageUrl = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRow_p2_0QR5ExOF6fj3s7VPt_JWm0gB3IODw&s",
                            IsEndemic = false,

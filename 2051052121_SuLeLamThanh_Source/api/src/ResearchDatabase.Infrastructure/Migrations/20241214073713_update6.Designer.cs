...
namespace ResearchDatabase.Infrastructure.Migrations
{
    ...
    [Migration("20241214073713_update6")]
            ...
            modelBuilder.Entity("ResearchDatabase.Domain.Entities.ResearchRecord", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Notes = "GTM-001",
                            ResearchDate = new DateTime(2020, 12, 14, 14, 37, 12, 922, DateTimeKind.Local).AddTicks(3),
                            ResearchSubjectId = 1,
                            Result = "Successful"
                        },
                        new
                        {
                            ...
                            Notes = "GTM-002",
                            ResearchDate = new DateTime(2022, 12, 14, 14, 37, 12, 922, DateTimeKind.Local).AddTicks(1202),
                            ResearchSubjectId = 2,
                        ...
                        new
                        {
                            ...
                            Notes = "GTM-002",
                            ResearchDate = new DateTime(2023, 12, 14, 14, 37, 12, 922, DateTimeKind.Local).AddTicks(1208),
                            ResearchSubjectId = 3,
            ...
            modelBuilder.Entity("ResearchDatabase.Domain.Entities.ResearchSubject", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2024, 12, 14, 14, 37, 12, 921, DateTimeKind.Local).AddTicks(2981),
                            Name = "Lion Conservation",
                            Project = "Save the Lions",
                            StartDate = new DateTime(2019, 12, 14, 14, 37, 12, 918, DateTimeKind.Local).AddTicks(5998),
                            Status = "Completed",
                            TeamMembers = "Team A"
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2021, 12, 14, 14, 37, 12, 921, DateTimeKind.Local).AddTicks(4451),
                            Status = "Ongoing",
                            TeamMembers = "Team B"
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2022, 12, 14, 14, 37, 12, 921, DateTimeKind.Local).AddTicks(4464),
                            Status = "Ongoing",
                            TeamMembers = "Team C"
                        });
                });

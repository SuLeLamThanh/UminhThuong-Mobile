...
namespace ResearchDatabase.Infrastructure.Migrations
{
    ...
    [Migration("20241214063929_update3")]
            ...
            modelBuilder.Entity("ResearchDatabase.Domain.Entities.ResearchRecord", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Notes = "GTM-001",
                            ResearchDate = new DateTime(2020, 12, 14, 13, 39, 28, 15, DateTimeKind.Local).AddTicks(5737),
                            ResearchSubjectId = 1,
                            Result = "Successful"
                        },
                        new
                        {
                            ...
                            Notes = "GTM-002",
                            ResearchDate = new DateTime(2022, 12, 14, 13, 39, 28, 15, DateTimeKind.Local).AddTicks(6868),
                            ResearchSubjectId = 2,
                        ...
                        new
                        {
                            ...
                            Notes = "GTM-002",
                            ResearchDate = new DateTime(2023, 12, 14, 13, 39, 28, 15, DateTimeKind.Local).AddTicks(6874),
                            ResearchSubjectId = 3,
            ...
            modelBuilder.Entity("ResearchDatabase.Domain.Entities.ResearchSubject", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2024, 12, 14, 13, 39, 28, 15, DateTimeKind.Local).AddTicks(897),
                            Name = "Lion Conservation",
                            Project = "Save the Lions",
                            StartDate = new DateTime(2019, 12, 14, 13, 39, 28, 13, DateTimeKind.Local).AddTicks(9423),
                            Status = "Completed",
                            TeamMembers = "Team A"
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2021, 12, 14, 13, 39, 28, 15, DateTimeKind.Local).AddTicks(1996),
                            Status = "Ongoing",
                            TeamMembers = "Team B"
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2022, 12, 14, 13, 39, 28, 15, DateTimeKind.Local).AddTicks(2006),
                            Status = "Ongoing",
                            TeamMembers = "Team C"
                        });
                });

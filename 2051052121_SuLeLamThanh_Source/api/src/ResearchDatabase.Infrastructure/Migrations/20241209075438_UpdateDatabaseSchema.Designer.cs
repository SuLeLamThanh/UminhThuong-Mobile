...
namespace ResearchDatabase.Infrastructure.Migrations
{
    ...
    [Migration("20241209075438_UpdateDatabaseSchema")]
            ...
            modelBuilder.Entity("ResearchDatabase.Domain.Entities.ResearchRecord", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Notes = "GTM-001",
                            ResearchDate = new DateTime(2020, 12, 9, 14, 54, 36, 528, DateTimeKind.Local).AddTicks(9318),
                            ResearchSubjectId = 1,
                            Result = "Successful"
                        },
                        new
                        {
                            ...
                            Notes = "GTM-002",
                            ResearchDate = new DateTime(2022, 12, 9, 14, 54, 36, 529, DateTimeKind.Local).AddTicks(1400),
                            ResearchSubjectId = 2,
                        ...
                        new
                        {
                            ...
                            Notes = "GTM-002",
                            ResearchDate = new DateTime(2023, 12, 9, 14, 54, 36, 529, DateTimeKind.Local).AddTicks(1410),
                            ResearchSubjectId = 3,
            ...
            modelBuilder.Entity("ResearchDatabase.Domain.Entities.ResearchSubject", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2024, 12, 9, 14, 54, 36, 527, DateTimeKind.Local).AddTicks(9877),
                            Name = "Lion Conservation",
                            Project = "Save the Lions",
                            StartDate = new DateTime(2019, 12, 9, 14, 54, 36, 526, DateTimeKind.Local).AddTicks(2453),
                            Status = "Completed",
                            TeamMembers = "Team A"
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2021, 12, 9, 14, 54, 36, 528, DateTimeKind.Local).AddTicks(2217),
                            Status = "Ongoing",
                            TeamMembers = "Team B"
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2022, 12, 9, 14, 54, 36, 528, DateTimeKind.Local).AddTicks(2240),
                            Status = "Ongoing",
                            TeamMembers = "Team C"
                        });
                });

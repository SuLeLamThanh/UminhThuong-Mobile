...
namespace ResearchDatabase.Infrastructure.Migrations
{
    ...
    [Migration("20241210035213_updatedata5")]
            ...
            modelBuilder.Entity("ResearchDatabase.Domain.Entities.ResearchRecord", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Notes = "GTM-001",
                            ResearchDate = new DateTime(2020, 12, 10, 10, 52, 12, 532, DateTimeKind.Local).AddTicks(3041),
                            ResearchSubjectId = 1,
                            Result = "Successful"
                        },
                        new
                        {
                            ...
                            Notes = "GTM-002",
                            ResearchDate = new DateTime(2022, 12, 10, 10, 52, 12, 532, DateTimeKind.Local).AddTicks(4263),
                            ResearchSubjectId = 2,
                        ...
                        new
                        {
                            ...
                            Notes = "GTM-002",
                            ResearchDate = new DateTime(2023, 12, 10, 10, 52, 12, 532, DateTimeKind.Local).AddTicks(4269),
                            ResearchSubjectId = 3,
            ...
            modelBuilder.Entity("ResearchDatabase.Domain.Entities.ResearchSubject", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2024, 12, 10, 10, 52, 12, 531, DateTimeKind.Local).AddTicks(8209),
                            Name = "Lion Conservation",
                            Project = "Save the Lions",
                            StartDate = new DateTime(2019, 12, 10, 10, 52, 12, 530, DateTimeKind.Local).AddTicks(7632),
                            Status = "Completed",
                            TeamMembers = "Team A"
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2021, 12, 10, 10, 52, 12, 531, DateTimeKind.Local).AddTicks(9335),
                            Status = "Ongoing",
                            TeamMembers = "Team B"
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2022, 12, 10, 10, 52, 12, 531, DateTimeKind.Local).AddTicks(9346),
                            Status = "Ongoing",
                            TeamMembers = "Team C"
                        });
                });

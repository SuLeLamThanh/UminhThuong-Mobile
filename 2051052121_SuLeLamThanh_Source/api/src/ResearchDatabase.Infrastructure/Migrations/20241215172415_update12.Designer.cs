...
namespace ResearchDatabase.Infrastructure.Migrations
{
    ...
    [Migration("20241215172415_update12")]
            ...
            modelBuilder.Entity("ResearchDatabase.Domain.Entities.ResearchRecord", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Notes = "GTM-001",
                            ResearchDate = new DateTime(2020, 12, 16, 0, 24, 14, 440, DateTimeKind.Local).AddTicks(9941),
                            ResearchSubjectId = 1,
                            Result = "Successful"
                        },
                        new
                        {
                            ...
                            Notes = "GTM-002",
                            ResearchDate = new DateTime(2022, 12, 16, 0, 24, 14, 441, DateTimeKind.Local).AddTicks(1441),
                            ResearchSubjectId = 2,
                        ...
                        new
                        {
                            ...
                            Notes = "GTM-002",
                            ResearchDate = new DateTime(2023, 12, 16, 0, 24, 14, 441, DateTimeKind.Local).AddTicks(1450),
                            ResearchSubjectId = 3,
            ...
            modelBuilder.Entity("ResearchDatabase.Domain.Entities.ResearchSubject", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2024, 12, 16, 0, 24, 14, 440, DateTimeKind.Local).AddTicks(4903),
                            Name = "Lion Conservation",
                            Project = "Save the Lions",
                            StartDate = new DateTime(2019, 12, 16, 0, 24, 14, 439, DateTimeKind.Local).AddTicks(4561),
                            Status = "Completed",
                            TeamMembers = "Team A"
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2021, 12, 16, 0, 24, 14, 440, DateTimeKind.Local).AddTicks(5998),
                            Status = "Ongoing",
                            TeamMembers = "Team B"
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2022, 12, 16, 0, 24, 14, 440, DateTimeKind.Local).AddTicks(6009),
                            Status = "Ongoing",
                            TeamMembers = "Team C"
                        });
                });

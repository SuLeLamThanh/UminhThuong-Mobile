...
namespace ResearchDatabase.Infrastructure.Migrations
{
    ...
    [Migration("20241210030623_updatedata3")]
            ...
            modelBuilder.Entity("ResearchDatabase.Domain.Entities.ResearchRecord", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Notes = "GTM-001",
                            ResearchDate = new DateTime(2020, 12, 10, 10, 6, 22, 34, DateTimeKind.Local).AddTicks(2464),
                            ResearchSubjectId = 1,
                            Result = "Successful"
                        },
                        new
                        {
                            ...
                            Notes = "GTM-002",
                            ResearchDate = new DateTime(2022, 12, 10, 10, 6, 22, 34, DateTimeKind.Local).AddTicks(3744),
                            ResearchSubjectId = 2,
                        ...
                        new
                        {
                            ...
                            Notes = "GTM-002",
                            ResearchDate = new DateTime(2023, 12, 10, 10, 6, 22, 34, DateTimeKind.Local).AddTicks(3751),
                            ResearchSubjectId = 3,
            ...
            modelBuilder.Entity("ResearchDatabase.Domain.Entities.ResearchSubject", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2024, 12, 10, 10, 6, 22, 33, DateTimeKind.Local).AddTicks(7227),
                            Name = "Lion Conservation",
                            Project = "Save the Lions",
                            StartDate = new DateTime(2019, 12, 10, 10, 6, 22, 32, DateTimeKind.Local).AddTicks(6812),
                            Status = "Completed",
                            TeamMembers = "Team A"
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2021, 12, 10, 10, 6, 22, 33, DateTimeKind.Local).AddTicks(8372),
                            Status = "Ongoing",
                            TeamMembers = "Team B"
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2022, 12, 10, 10, 6, 22, 33, DateTimeKind.Local).AddTicks(8383),
                            Status = "Ongoing",
                            TeamMembers = "Team C"
                        });
                });

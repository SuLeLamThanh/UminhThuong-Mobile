...
namespace ResearchDatabase.Infrastructure.Migrations
{
    ...
    [Migration("20241214112132_update7")]
            ...
            modelBuilder.Entity("ResearchDatabase.Domain.Entities.ResearchRecord", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Notes = "GTM-001",
                            ResearchDate = new DateTime(2020, 12, 14, 18, 21, 31, 932, DateTimeKind.Local).AddTicks(6781),
                            ResearchSubjectId = 1,
                            Result = "Successful"
                        },
                        new
                        {
                            ...
                            Notes = "GTM-002",
                            ResearchDate = new DateTime(2022, 12, 14, 18, 21, 31, 932, DateTimeKind.Local).AddTicks(8020),
                            ResearchSubjectId = 2,
                        ...
                        new
                        {
                            ...
                            Notes = "GTM-002",
                            ResearchDate = new DateTime(2023, 12, 14, 18, 21, 31, 932, DateTimeKind.Local).AddTicks(8068),
                            ResearchSubjectId = 3,
            ...
            modelBuilder.Entity("ResearchDatabase.Domain.Entities.ResearchSubject", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2024, 12, 14, 18, 21, 31, 932, DateTimeKind.Local).AddTicks(2358),
                            Name = "Lion Conservation",
                            Project = "Save the Lions",
                            StartDate = new DateTime(2019, 12, 14, 18, 21, 31, 931, DateTimeKind.Local).AddTicks(3114),
                            Status = "Completed",
                            TeamMembers = "Team A"
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2021, 12, 14, 18, 21, 31, 932, DateTimeKind.Local).AddTicks(3393),
                            Status = "Ongoing",
                            TeamMembers = "Team B"
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2022, 12, 14, 18, 21, 31, 932, DateTimeKind.Local).AddTicks(3404),
                            Status = "Ongoing",
                            TeamMembers = "Team C"
                        });
                });
